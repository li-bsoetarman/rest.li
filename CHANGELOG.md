...
- When bumping the project version in your commit, run the `./scripts/bump-changelog`
...
## [Unreleased]
- Add new changelog (`CHANGELOG.md`) and changelog helper script (`./scripts/bump-changelog`).
